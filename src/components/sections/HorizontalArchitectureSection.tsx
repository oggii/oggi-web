    ...
    <>
      ...
      <div className="relative z-30 bg-luxota-bg hidden lg:block">
        <div className="pin-spacer relative w-full overflow-hidden">
          <section ref={pinSectionRef} className="h-screen relative overflow-hidden bg-luxota-bg flex flex-col justify-center border-t border-white/5">
            <div className="absolute top-20 left-0 w-full px-12 flex justify-between items-end z-20">
              <div>
                <span className="text-xs text-luxota-accent font-mono mb-3 block tracking-widest">{t('architecture.tag')}</span>
                <h2 className="text-4xl font-medium text-white tracking-tight">{t('architecture.title')}</h2>
              </div>
              <div className="flex items-center gap-3 text-white/30">
                <div className="w-8 h-8 rounded-full border border-white/10 flex items-center justify-center">
                  <Icon icon="solar:mouse-circle-linear" className="animate-bounce text-lg"></Icon>
                </div>
                <span className="text-xs font-mono tracking-widest">{t('architecture.p1')}</span>
              </div>
            </div>
              ...
              <div className="w-[70vw] max-w-[900px] h-[65vh] spotlight-card rounded-[2.5rem] p-16 shrink-0 relative flex overflow-hidden border border-white/10 bg-[#050507]">
                <div className="w-5/12 flex flex-col justify-between relative z-10 h-full">
                  <div>
                    ...
                    <h3 className="text-5xl text-white font-medium mb-6 tracking-tight">{t('architecture.b1Title')}</h3>
                    <p className="text-lg text-luxota-dim leading-relaxed">
                      {t('architecture.b1Desc')}
                    </p>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-center gap-4 text-sm text-white/90">
                      ...
                      {t('architecture.b1Item1')}
                    </li>
                    <li className="flex items-center gap-4 text-sm text-white/90">
                      <div className="w-6 h-6 rounded-full bg-luxota-accent/10 flex items-center justify-center">
                        <Icon icon="solar:check-circle-linear" className="text-luxota-accent"></Icon>
                      </div>
                      {t('architecture.b1Item2')}
                    </li>
                  </ul>
                </div>
              ...
              <div className="w-[70vw] max-w-[900px] h-[65vh] spotlight-card rounded-[2.5rem] p-16 shrink-0 relative flex overflow-hidden border border-white/10 bg-[#050507]">
                <div className="w-5/12 flex flex-col justify-between relative z-10 h-full">
                  <div>
                    ...
                    <h3 className="text-5xl text-white font-medium mb-6 tracking-tight">{t('architecture.b2Title')}</h3>
                    <p className="text-lg text-luxota-dim leading-relaxed">
                      {t('architecture.b2Desc')}
                    </p>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-center gap-4 text-sm text-white/90">
                      ...
                      {t('architecture.b2Item1')}
                    </li>
                    <li className="flex items-center gap-4 text-sm text-white/90">
                      <div className="w-6 h-6 rounded-full bg-luxota-accent/10 flex items-center justify-center">
                        <Icon icon="solar:check-circle-linear" className="text-luxota-accent"></Icon>
                      </div>
                      {t('architecture.b2Item2')}
                    </li>
                  </ul>
                </div>
                <div className="w-7/12 absolute right-0 top-0 bottom-0 bg-gradient-to-l from-white/[0.02] to-transparent flex items-center justify-center overflow-hidden card-graphic-wrapper pointer-events-none">
              ...
              <div className="w-[70vw] max-w-[900px] h-[65vh] spotlight-card rounded-[2.5rem] p-16 shrink-0 relative flex overflow-hidden border border-white/10 bg-[#050507]">
                <div className="w-5/12 flex flex-col justify-between relative z-10 h-full">
                  <div>
                    ...
                    <h3 className="text-5xl text-white font-medium mb-6 tracking-tight">{t('architecture.b3Title')}</h3>
                    <p className="text-lg text-luxota-dim leading-relaxed">
                      {t('architecture.b3Desc')}
                    </p>
                  </div>
                  <ul className="space-y-4">
                    <li className="flex items-center gap-4 text-sm text-white/90">
                      ...
                      {t('architecture.b3Item1')}
                    </li>
                    <li className="flex items-center gap-4 text-sm text-white/90">
                      <div className="w-6 h-6 rounded-full bg-luxota-accent/10 flex items-center justify-center">
                        <Icon icon="solar:check-circle-linear" className="text-luxota-accent"></Icon>
                      </div>
                      {t('architecture.b3Item2')}
                    </li>
                  </ul>
                </div>
                <div className="w-7/12 absolute right-0 top-0 bottom-0 bg-gradient-to-l from-white/[0.02] to-transparent flex items-center justify-center overflow-hidden card-graphic-wrapper pointer-events-none">
      ...
      <section className="block lg:hidden px-6 py-16 lg:py-20 space-y-8 bg-luxota-bg border-t border-white/5">
        ...
        <div className="spotlight-card rounded-3xl p-8 border border-white/10">
          ...
          <p className="text-sm text-luxota-dim">{t('architecture.fallback1Desc')}</p>
        </div>
        <div className="spotlight-card rounded-3xl p-8 border border-white/10">
          <h3 className="text-2xl text-white font-medium mb-2">{t('architecture.b2Title')}</h3>
          <p className="text-sm text-luxota-dim">{t('architecture.fallback2Desc')}</p>
        </div>
        <div className="spotlight-card rounded-3xl p-8 border border-white/10">
          <h3 className="text-2xl text-white font-medium mb-2">{t('architecture.b3Title')}</h3>
          <p className="text-sm text-luxota-dim">{t('architecture.fallback3Desc')}</p>
        </div>
      </section>
    </>
  );
