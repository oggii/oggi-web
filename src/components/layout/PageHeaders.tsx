...
export function ServicesPageHeader() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 mb-20 relative z-10">
            <span className="text-xs text-luxota-accent font-mono mb-4 block tracking-widest opacity-0 reveal-hero-fade">{t('servicesPage.tag')}</span>
...
export function PortfolioPageHeader() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 mb-20 relative z-10">
            <span className="text-xs text-luxota-accent font-mono mb-4 block tracking-widest opacity-0 reveal-hero-fade">{t('portfolio.pageTag')}</span>
...
export function PurposePageHeader() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-6 mb-10 relative z-10">
            <span className="text-xs text-luxota-accent font-mono mb-4 block tracking-widest opacity-0 reveal-hero-fade uppercase">{t('purpose.pageTag')}</span>
            <h1 className="text-5xl md:text-8xl font-medium tracking-tight text-white mb-6 opacity-0 reveal-hero-fade">
                {t('purpose.pageTitle')}
            </h1>
        </div>
