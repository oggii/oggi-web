      ...
      <section className="py-32 px-6 text-center border-t border-white/5 relative overflow-hidden bg-[#020203] reveal-up">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <a href="/#action" className="group relative inline-flex px-12 py-5 bg-white text-luxota-bg rounded-full overflow-hidden transition-all hover:scale-105 shadow-[0_0_40px_-10px_rgba(255,255,255,0.4)]">
              <span className="relative z-10 text-sm font-bold flex items-center gap-2">
